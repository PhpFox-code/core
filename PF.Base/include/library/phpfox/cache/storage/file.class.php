...
class Phpfox_Cache_Storage_File extends Phpfox_Cache_Abstract
{
	...
	private function _getName($sFile)
	{
		...
		$sPath = PHPFOX_DIR_CACHE . (Phpfox::getParam('core.cache_add_salt') ? md5(Phpfox::getParam('core.salt') . $sFile) : $sFile) . Phpfox::getParam('core.cache_suffix');
